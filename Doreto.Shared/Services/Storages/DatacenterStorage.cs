...
namespace Doreto.Shared.Services.Storages;
...
public class DatacenterStorage
{
    ...
    /// </summary>
    public static readonly string DoretroInteropPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Doreto.Interop.dll");
}
